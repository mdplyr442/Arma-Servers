...
#Specific
$Port = 2442
$ProfilesPath = Join-Path -Path $PSScriptRoot -ChildPath "..\logs_testing"
$ConfigPath = Join-Path -Path $PSScriptRoot -ChildPath "..\configs\testing.cfg"
$ExePath = Join-Path -Path $PSScriptRoot -ChildPath "..\server_testing\arma3serverprofiling_x64.exe"
