...
$arguments = "-client -connect=127.0.0.1 -port=2302 -password=$joinPassword -profiles=F:\16AA\logs_main_hc\hc2 -malloc=mimalloc_v206_LockPages -hugepages -maxMem=16000 -limitFPS=500 -enableHT -mod=$mods"
