...
force l6AA_dzf_13aasr_group = "'4-3'";
force l6AA_dzf_16csmr_group = "'4-4'";
force l6AA_dzf_1plt_group = "'1 Plt HQ','1-1','1-2','1-3'";
force l6AA_dzf_2plt_group = "'2 Plt HQ','2-1','2-2','2-3'";
force l6AA_dzf_3plt_group = "'FSG HQ','FSG'";
force l6AA_dzf_4plt_group = "'CSM Grp','4-1'";
...
force force ace_common_checkPBOsWhitelist = "['fxp_VehHeli','jsrs_soundmod_16aa','fxp_VehPlane','jsrs_soundmod_boats','jsrs_soundmod_movement','jsrs_soundmod_rhs_afrf_weapons','fxp_VehTank','fxp_VehExpEffectBig','Blastcore_MainCore','jsrs_soundmod_framework','jsrs_soundmod_rhs_gref_weapons','jsrs_soundmod_complete_edition','jsrs_soundmod_complete_edition_soundfiles','jsrs_soundmod_sonic_cracks','jsrs_soundmod_cfg_rhs_usf_air_vehicles','jsrs_soundmod_cfg_rhs_afrf_weapons','jsrs_soundmod_weapons','fxp_adat','jsrs_soundmod_explosions','fxp_VehExpEffect','jsrs_soundmod_landvehicles','Ca','jsrs_soundmod_environment','jsrs_soundmod_cfg_rhs_usf_weapons','jsrs_soundmod_bullethits','jsrs_soundmod_cfg_rhs_afrf_vehicles','jsrs_soundmod_helicopters','jsrs_soundmod_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_vehicles','jsrs_soundmod_cfg_rhs_afrf_air_vehicles','blast_refract','PLP_commonModData','WarFXPE','MIRA_Vehicle_Medical','A3TI','Blastcore_VEP','WarFXPE_Weps','PLP_hidePasswords','OCAP_main','OCAP_extension','OCAP_recorder','dedmen_arma_script_profiler','dedmen_sqf_assembly','Intercept_Core','ES_main','ES_sounds','ES_sys','ESSP_compat_vn','ESSP_core','devgru_redsquadron_cracks','devgru_resquadron_sounds','jsrs_soundmod_configuration','jsrs_soundmod_reloadingsounds','jsrs_soundmod_reloadingsounds','kog_jsrs_soundmod_patches','igs_compat','unsung_reveal','JSRS_Soundmod_Cfg_RHS_AFRF_Weapons','JSRS_Soundmod_Cfg_RHS_GREF_Weapons','JSRS_Soundmod_Cfg_RHS_SAF_Weapons','JSRS_Soundmod_Cfg_RHS_USF_Weapons','JSRS_Soundmod_Cfg_RHS_USF_Weapons','Tier1JSRSCompat','Tier1OpticsNVG']";
...
force force kat_airway_CancelRecoveryPosition_Time = 8;
force force kat_airway_CheckAirway_time = 6;
force force kat_airway_checkbox_puking_sound = true;
force force kat_airway_enable = true;
force force kat_airway_Guedeltubus_time = 8;
...
force force kat_airway_occlusion_cooldownPeriod = 20;
...
force force kat_airway_RecoveryPosition_Time = 12;
...
force force kat_breathing_deterioratingPneumothorax_chance = 19.9438;
...
force force kat_breathing_medLvl_Pulseoximeter = 2;
...
force force kat_breathing_pneumothoraxDamageThreshold = 0.6;
...
force force kat_breathing_slightValue = 95;
...
force force kat_breathing_Stable_spo2 = 89.8258;
...
force force kat_circulation_AdvRhythm_AED_ROSC_Chance = 15;
force force kat_circulation_AdvRhythm_asystoleBloodlossThreshold = 4.03753;
...
force force kat_circulation_AdvRhythm_deteriorateTimeMax = 600;
...
force force kat_circulation_AdvRhythm_PEAChance = 29.9874;
force force kat_circulation_AdvRhythm_VTChance = 45.0528;
force force kat_circulation_AED_MaxChance = 70;
force force kat_circulation_AED_MinChance = 5;
force force kat_circulation_AED_X_MaxChance = 80;
force force kat_circulation_AED_X_MinChance = 10;
...
force force kat_circulation_AEDX_VitalsMonitor_AttachTime = 12;
force force kat_circulation_AEDX_VitalsMonitor_DetachTime = 10;
...
force force kat_circulation_CPR_ChanceInterval = 20;
...
force force kat_circulation_CPR_MinChance_Doctor = 4.87837;
...
force force kat_circulation_DefibrillatorPads_AttachTime = 12;
force force kat_circulation_DefibrillatorPads_DetachTime = 10;
...
force force kat_misc_AFAKSecondSlotItem = "[['kat_larynx', 10], ['kat_pocketBVM', 1], ['kat_naloxone', 10], ['kat_stethoscope', 1]]";
...
force force kat_pharma_blockChance = 10;
...
force force kat_surgery_compoundChance = 45;
...
force force kat_surgery_simpleChance = 75;
